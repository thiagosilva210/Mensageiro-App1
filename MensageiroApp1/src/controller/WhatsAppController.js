...
import { ContactsController } from "../util/ContactsController.js";
...
export class WhatsAppController {
  ...
  initAuth() {
    this._firebase
      ...
      .catch((err) => {
        console.error(err, "aqui está o erro");
      });
  }
    ...
    this._user.on("contactschange", (docs) => {
      ...
      docs.forEach((doc) => {
        ...
        <div class="_3j7s9">
            <div class="_2FBdJ">
                <div class="_25Ooe">
                    <span dir="auto" title="${contact.name}" class="_1wjpf">${
          contact.name
        }</span>
                </div>
                <div class="_3Bxar">
  ...
  loadElements() {
    ...
    document.querySelectorAll("[id]").forEach((element) => {
      this.el[Format.getCamelCase(element.id)] = element; //A função que está em format
    });
  }
  ...
  elementsPrototype() {
    ...
    Element.prototype.show = function () {
      ...
      return this; //retornar para que o próximo método possa executar no elemento
    };

    Element.prototype.toggle = function () {
      this.display =
        this.getElementsByClassName.display === "none" ? "block" : "none";
      return this;
    };

    Element.prototype.on = function (events, fn) {
      //Para facilitar quando é preciso utilizar os eventos de escuta
      //ex.: app.el.btnNewContact.on('click'), (event) =>{console.log("clique")}
    ...
    Element.prototype.css = function (styles) {
      //manipulação de estilos ex.: app.el.app({width:50%})
  ...
  initEvents() {
    ...
    this.el.myPhoto.on("click", (e) => {
      ...
      setTimeout(() => {
        this.el.panelEditProfile.addClass("open"); //ao clicar este elemento que está oculto será mostrado
      }, 300);
    });
    ...
    this.el.btnClosePanelEditProfile.on("click", (e) => {
      this.el.panelEditProfile.removeClass("open"); //ao clicar neste elemento que está sendo mostrado será ocultado
    });
    ...
    this.el.photoContainerEditProfile.on("click", (e) => {
      this.el.inputProfilePhoto.click(); //ao clicar ele abrirá a janela do s.o. pelo input file
    });
    ...
    this.el.inputPhoto.on("change", (e) => {
      [...this.el.inputPhoto.files].forEach((file) => {
        //spread, quantidade de elementos q ele tem e transforma nas posições certas
        ...
        this._documentPreviewController
          ...
          .catch((err) => {
            ...
            switch (file.type) {
              ...
              case "application/vnd.oasis.opendocument.text": //tipo de arquivo odt
    ...
    this.el.panelEmojis.querySelectorAll(".emojik").forEach((emoji) => {
      emoji.on("click", (e) => {
        ...
        // this.el.inputText.appendChild(img) sempre adiciona no final(appendChild)
        ...
        //para selecionar uma parte do texto digitado e poder substituir por um emoji, assim como colocá-lo nas diversas posições do input
        range = cursor.getRangeAt(0); //a primeira posição do range
